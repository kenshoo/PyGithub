...
class Repository(github.GithubObject.CompletableGithubObject):
    ...
    def get_issues(self, milestone=github.GithubObject.NotSet, state=github.GithubObject.NotSet, assignee=github.GithubObject.NotSet, mentioned=github.GithubObject.NotSet, labels=github.GithubObject.NotSet, sort=github.GithubObject.NotSet, direction=github.GithubObject.NotSet, since=github.GithubObject.NotSet, creator=github.GithubObject.NotSet):
        ...
        assert since is github.GithubObject.NotSet or isinstance(since, datetime.datetime), since
        assert creator is github.GithubObject.NotSet or isinstance(creator, github.NamedUser.NamedUser) or isinstance(creator, str), creator
        url_parameters = dict()
        if milestone is not github.GithubObject.NotSet:
    ...
    def protect_branch(self, branch, enabled, enforcement_level=github.GithubObject.NotSet, contexts=github.GithubObject.NotSet):
        ...
        assert enforcement_level is github.GithubObject.NotSet or isinstance(enforcement_level, str), enforcement_level
        assert contexts is github.GithubObject.NotSet or all(isinstance(element, str) or isinstance(element, str) for element in contexts), contexts
    ...
    def set_branch_protection(self, branch, enforce_admins=False, require_review_all=False, require_review=None, restrictions=None, **required_status_checks):
        """
